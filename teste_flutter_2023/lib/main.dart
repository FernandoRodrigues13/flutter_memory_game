...
class _DemoPageState extends State<_DemoPage> {
  ...
  void initState() {
    super.initState();
    _ensureVisibleGlobalKey = GlobalKey<EnsureVisibleState>();
    _strsToShow = _getRandomStrings();
    ...
    return DescribedFeatureOverlay(
      ...
      child: EnsureVisible(
        ...
        child: ElevatedButton.icon(
          ...
          onPressed: () {
            setState(() => _strsToShow = _getRandomStrings());
          },
    ...
    return Column(
      ...
      children: [
        ...
        DescribedFeatureOverlay(
          ...
          child: FloatingActionButton(
            onPressed: () {
              setState(() => _strsToShow.removeAt(0));
            },
            heroTag: 'minus_one',
